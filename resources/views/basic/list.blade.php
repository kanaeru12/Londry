...
<a href="{{ route('basic.create') }}" class="btn btn-primary mb-3" style="background-color: #14263d; color: rgb(255, 255, 255);">New User</a>
...
<table class="table table-bordered table-stripped">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <div class="d-flex">
                    <a href="{{ route('basic.edit', $user->id) }}" class="btn mr-2 rounded-circle py-2" style="background-color: rgb(238, 204, 9);"><i class="fas fa-fw fa-pen text-white"></i></a>
